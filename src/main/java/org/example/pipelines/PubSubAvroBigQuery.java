...
import org.example.functions.FormatAvroMessageToTableRowFn;
...
/**
 * Pipeline for
 * 1. Filter Read Avro Message from a PubSub
...
public class PubSubAvroBigQuery {
    ...
    public static void main(String[] args) {
        ...
        PubSubAvroBigQueryOptions options = PipelineOptionsFactory.fromArgs(args)
                .withValidation()
                .as(PubSubAvroBigQueryOptions.class);
        // Set the pipeline to do streaming processing
        options.setStreaming(true);
        // Get the schema from argument
        ...
        receivedMessage.apply(new WriteToBigQuery<>(options, new FormatAvroMessageToTableRowFn(avroSchema)));
